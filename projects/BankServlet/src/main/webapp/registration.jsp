...
<h1>Регистрация</h1>
<div id="wrapper">
    <form id="signin" method="" action="/UserReg" autocomplete="off">
        <input type="text" id="user" name="user" placeholder="username" formmethod="post"/>
        <input type="password" id="pass" name="pass" placeholder="password" formmethod="post"/>
